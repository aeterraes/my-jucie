...
restoreOverwrittenFilesWithOriginals().then(() => {
  ...
  /* /ftp directory browsing and file download */ // vuln-code-snippet neutral-line directoryListingChallenge
    app.use('/ftp', express.static(path.resolve('ftp')))// vuln-code-snippet vuln-line directoryListingChallenge
  ...
  /* /encryptionkeys directory browsing */
    app.use('/encryptionkeys', express.static(path.resolve('encryptionkeys')))
  app.use('/encryptionkeys/:file', serveKeyFiles())

  /* /logs directory browsing */ // vuln-code-snippet neutral-line accessLogDisclosureChallenge
    app.use('/support/logs', express.static(path.resolve('logs')))// vuln-code-snippet vuln-line accessLogDisclosureChallenge
